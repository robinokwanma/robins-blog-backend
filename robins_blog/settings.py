"""
Django settings for robins_blog project.
...
SECRET_KEY = 'django-insecure-2g5i(*d_lsthmsfcz!@1snro3ua7f2%otr6cxwu2pwsl0kldbd'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Allow access only to authenticated users
    ],
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '1000/hour', #1000 calls for anonymous users
...
WSGI_APPLICATION = 'robins_blog.wsgi.application'
